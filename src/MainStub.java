...
//		Graph graph = new Lollipop(1_000).graph;
		...
		System.out.println("Average computation time: " 
							+ delay / (nbrOfSamples * 1_000_000) + "ms = " + (delay / (nbrOfSamples * 1_000_000))/1000 + "s");
	...
	private static void showGrid(
		...
		/*
		try {
			laby.saveImage("C:\\Users\\Dang Dinh NGUYEN\\Documents\\L3_INFO\\Algo\\ArbresCouvrants\\src\\random.png");
